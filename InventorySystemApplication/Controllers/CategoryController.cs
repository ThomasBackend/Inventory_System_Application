    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.CategoriesTable != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.CategoriesTable'  is null.");
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var category = await _context.CategoriesTable.FindAsync(id);
            if (category == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.CategoriesTable'  is null.");
            }
            var category = await _context.CategoriesTable.FindAsync(id);
            if (category != null)
            {
        ...
        {
          return (_context.CategoriesTable?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
